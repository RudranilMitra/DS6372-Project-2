...
bank[,-21] %>% keep(is.numeric) %>% na.omit %>% cor %>% corrplot("upper", addCoef.col = "black", number.digits = 2, number.cex = 0.5, method="shade", order = "hclust", tl.srt=45, tl.cex = 0.8)
...
From the downsampled bank data, we will break the data set up into training and test to fit our basic models
```{r}
